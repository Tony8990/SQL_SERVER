...
*/
/*
Select a.nome,SUM(p.BottiglieVendute) as 'Numero bottiglie Prodotte' from 
Produzione p inner join Azienda a on
p.IdAzienda=a.Id where p.Data between '2017-05-01' and '2017-12-01'
group by a.nome
go
*/
/*
...
from Azienda a inner join Cassa c on
c.IdAzienda=a.Id
where c.Tipologia='Cabernet'and c.Annata=2011 and c.Denominazione like
'%DOC%'
group by a.Nome
...
from Azienda a inner join Cassa c
on c.IdAzienda=a.Id
where c.DataVendita between '2016-06-01' and '2016-10-01' and c.Denominazione like '%VDT%'
